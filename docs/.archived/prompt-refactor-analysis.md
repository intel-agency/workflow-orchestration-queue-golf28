...
|---|---|---|---|
| `.github/workflows/orchestrator-agent.yml` | `workflow-orchestration-queue-golf28` | A, D | **DONE** |
| `.github/workflows/prompts/orchestrator-agent-prompt.md` | `workflow-orchestration-queue-golf28` | B, D | **DONE** |
| `.github/.labels.json` | `workflow-orchestration-queue-golf28` | C, D, L | **DONE** |
